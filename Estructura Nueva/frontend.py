...
st.set_page_config(page_title="Presupuesto Participativo - Vicente López", page_icon="🏛️")
st.title("🏛️ Predicción de Proyectos - Presupuesto Participativo")
st.markdown("Sistema de Soporte de Decisiones para evaluar proyectos de Vicente López (modelo Random Forest)")
